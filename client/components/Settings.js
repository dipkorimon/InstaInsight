    ...
    return (
        <div className="min-h-120 bg-gray-900 flex">
            ...
            <nav className="w-72 bg-gray-900 border-r border-gray-400 pr-4 flex flex-col">
                    ...
                    {tabs.map((tab) => (
                        <li key={tab.key}>
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-2 rounded-md text-sm text-gray-300 font-medium w-full text-left
                  ${
                                    selectedTab === tab.key
                                        ? "bg-gray-800"
                ...
                {/* Optional footer */}
                <div className="text-xs text-gray-400 mt-8 font-bold">v1.0.0</div>
            </nav>
